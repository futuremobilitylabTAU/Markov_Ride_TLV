...
class Demand:
    def __init__(self, requst,taz_info,number_of_cluster):
        ...
        self.requst = self.KMeans(requst)
...
#        requst_cluster=pd.concat([requst,labels_df],axis=1)
        ...
        self.regions=dec 
        section_cord = pd.read_csv(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Keys\section_coordination_by_taz.csv')
        #Voronoi Lines
    ...
    def geo_data_anlysis(self):
        ...
        pointShp=fiona.open(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Markov_decision_process\model_3\Shape_file\points_origins.shp',mode='w',driver='ESRI Shapefile',schema=schema,crs="EPSG:2039")
        ...
        polyShp=fiona.open(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Markov_decision_process\model_3\Shape_file\clusters.shp',mode='w',driver='ESRI Shapefile',schema=schema,crs="EPSG:2039")
    ...
    def add_clusters_to_centroids(self):
           ...
           cluster_shape = gpd.GeoDataFrame.from_file(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Markov_decision_process\model_3\Shape_file\clusters.shp')
    ...
    def add_clusters_to_detantion(self):
        ...
        self.requst['coords']=self.requst.apply(lambda x: [x['destination']['x'],x['destination']['y']],axis=1)
...
class MDP_Data:
    def __init__(self,number_of_energy_levels,number_of_clusters, requst,taz_info,supply_info):
        ...
        ##Set Up Time 6-11
        simulation_starting=6
        simulation_ending=11
        simulation_ending=(simulation_ending-simulation_starting)*60*60
        
        markov_start_time=0
        markov_end_time=simulation_ending
        ...
        self.supply_info=supply_info[(supply_info['entranceTime']>=markov_start_time)&(supply_info['entranceTime']<=markov_end_time)]
        

  
        self.demand.geo_data_anlysis()    

        
        self.demand.add_clusters_to_centroids()
        


        self.demand.add_clusters_to_detantion()
   ...
   #             print(area_dest,area_or)
    ...
    def check_transition(self):
        df=pd.read_csv(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Markov_decision_process\model_3\Transitions\trans_df.csv')
        ...
        df_3.to_csv(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Markov_decision_process\model_3\Transitions\trans_df.csv',index=False)
    ...
    def make_data_frames(self):
        ...
        rew_df.to_csv(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Markov_decision_process\model_3\Reword\rew_df.csv',index=False)
        ...
        trans_df['Next State'] = trans_df['Next State'].str.replace(" ", '')
        trans_df.to_csv(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Markov_decision_process\model_3\Transitions\trans_df.csv',index=False)
        self.check_transition()

        
#%%

taz_info = pd.read_csv(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Keys\zones_numbering.csv')
requst=pd.read_json(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Demand\Amod_schedule\requst_2040.json')
#%%

trajectory=pd.read_csv(r'C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\Optimizing_Mobility_with_Markovian_Model_for_AMoD\Data\Supply\path_with_kwh.csv')
#%%
