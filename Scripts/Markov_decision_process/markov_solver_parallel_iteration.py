...
def main():
    ...
    Transitions = pd.read_csv(r'/home/bathen/Dropbox/Optimizing_Mobility_with_Markovian_Model_for_AMoD/Data/Markov_decision_process/model_6/Transitions/trans_df.csv')
    Reward = pd.read_csv(r'/home/bathen/Dropbox/Optimizing_Mobility_with_Markovian_Model_for_AMoD/Data/Markov_decision_process/model_6/Reword/rew_df.csv')
    gamma =0.9
...
#C:\Users\dadashev\Future Mobility Lab Dropbox\Future Mobility Lab TAU\
    ...
    with Manager() as manager:
        ...
        while m.delta > epsilon:
            ...
            pi_df.to_csv(r"/home/bathen/Dropbox/Optimizing_Mobility_with_Markovian_Model_for_AMoD/Data/Markov_decision_process/model_6/Outputs/optimal_VI_%s.csv"%(count), index=False)
            v_df.to_csv(r"/home/bathen/Dropbox/Optimizing_Mobility_with_Markovian_Model_for_AMoD/Data/Markov_decision_process/model_6/Outputs/optimal_state_value_%s.csv"%(count), index=False)
